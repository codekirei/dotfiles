...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="kirei"
  ...
  # Uncomment these if you want to enable tmux bindings for muting (hiding) one
  # of the status bars. E.g. this example binding would mute the left status
  # bar when pressing <prefix> followed by Ctrl-[
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/6z/qsskf08x71z67m7k5y1t2wcc0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/jacob/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/jacob/.mailcheckrc"
# }
